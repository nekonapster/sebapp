    ...
    <form wire:submit='toBd'>
        <div class="flex">
            <input wire:model='fechaSaldos' type="text" placeholder=" {{ __('Date') }} "
                class="input input-sm input-bordered w-40 mb-3 ml-7" onfocus="(this.type='date')" required />
        </div>
        ...
        <div class="flex justify-evenly">
            <fieldset class="border border-gray-600 rounded-xl p-3 max-w-40">
                ...
                <input wire:model='provincia.a893' type="number"
                    ...
                    class="input input-sm input-bordered max-w-40 mb-2 @error('provincia.a893') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='provincia.a430' type="number"
                    placeholder="@error('provincia.a430') {{ $message }} @else A430 @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('provincia.a430') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='provincia.parroquia' type="number"
                    placeholder="@error('provincia.parroquia') {{ $message }} @else PARROQUIA @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('provincia.parroquia') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='provincia.adm' type="number"
                    placeholder="@error('provincia.adm') {{ $message }} @else ADM @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('provincia.adm') border-red-500 text-red-500 @enderror"
                    step="0.01" />
            </fieldset>
            ...
            <fieldset class="border border-gray-600 rounded-xl p-3 max-w-40">
                ...
                <input wire:model='santander.sant1' type="number"
                    ...
                    class="input input-sm input-bordered max-w-40 mb-2 @error('santander.sant1') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='santander.sant2' type="number"
                    placeholder="@error('santander.sant2') {{ $message }} @else Sant 2 @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('santander.sant2') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='santander.sant3' type="number"
                    placeholder="@error('santander.sant3') {{ $message }} @else Sant 3 @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('santander.sant3') border-red-500 text-red-500 @enderror"
                    step="0.01" />
            </fieldset>
            ...
            <fieldset class="border border-gray-600 rounded-xl p-3 max-w-40">
                ...
                <input wire:model='santanderP.893' type="number"
                    ...
                    class="input input-sm input-bordered max-w-40 mb-2 @error('santanderP.893') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='santanderP.430' type="number"
                    placeholder="@error('santanderP.430') {{ $message }} @else 430 @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('santanderP.430') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='santanderP.1486' type="number"
                    placeholder="@error('santanderP.1486') {{ $message }} @else 1486 @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('santanderP.1486') border-red-500 text-red-500 @enderror"
                    step="0.01" />
            </fieldset>
            ...
            <fieldset class="border border-gray-600 rounded-xl p-3 max-w-40">
                ...
                <input wire:model='fci.fciA' type="number"
                    ...
                    class="input input-sm input-bordered max-w-40 mb-2 @error('fci.fciA') border-red-500 text-red-500 @enderror"
                    step="0.01" />
                <input wire:model='fci.fciPlus' type="number"
                    placeholder="@error('fci.fciPlus') {{ $message }} @else FCI Plus @enderror"
                    class="input input-sm input-bordered max-w-40 mb-2 @error('fci.fciPlus') border-red-500 text-red-500 @enderror"
                    step="0.01" />
            </fieldset>
            ...
            <div>
                <fieldset class="border border-gray-600 rounded-xl p-3 max-w-40 mb-2">
                    ...
                    <input wire:model='digital.mercadoPago' type="number"
                        ...
                        class="input input-sm input-bordered max-w-40 mb-2 @error('digital.mercadoPago') border-red-500 text-red-500 @enderror"
                        step="0.01" />
                </fieldset>
                ...
                <fieldset class="border border-gray-600 rounded-xl p-3 max-w-40">
                    ...
                    <input wire:model='efectivo.caja' type="number"
                        ...
                        class="input input-sm input-bordered max-w-40 mb-2 @error('efectivo.caja') border-red-500 text-red-500 @enderror"
                        step="0.01" />
                </fieldset>
            </div>
        </div>
        ...
        <div>
            <div class="mt-10 flex justify-between items-center">
                <div>
                    <button wire:click.prevent='calcularTotal' class="btn btn-sm btn-accent mr-3 ml-7">Calcular
                        total</button>

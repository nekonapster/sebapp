<div wire:poll.3>
    ...
    <div class="overflow-x-auto px-5">
        <table class="table table-xs text-center bg-base-100">
            ...
            <thead>
                <tr>
                    <th class="w-1/6 pt-5 pb-5 text-base-content">Nombre de la coleccion</th>
                    <th class="w-96 pt-5 pb-5 text-base-content">Numero de documentos</th>
                    <th class="w-1 pt-5 pb-5 text-base-content">Accion</th>
                </tr>
            </thead>
            <tbody>
                <!-- row 1 -->

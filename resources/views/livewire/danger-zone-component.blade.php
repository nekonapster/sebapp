<div wire:poll.3>
    @if (session('msg'))
    {{-- <div role="alert" class="alert alert-success flex justify-center mb-5 drop-shadow-xl" id="alert-message"> --}}
    <div role="alert" class="alert alert-success mb-5 drop-shadow-xl" id="alert-message">
        {{session('msg')}}
    </div>
    @endif
    <div class="overflow-x-auto text-center">
        <table class="table text-center mt-10 flex justify-evenly">
            <!-- head -->
            <thead>
                <tr>
    ...
    <dialog id="dangerZone" class="modal" wire:ignore.self>
        <div class="modal-box">
            <h3 class="text-lg font-bold">Atencion!</h3>

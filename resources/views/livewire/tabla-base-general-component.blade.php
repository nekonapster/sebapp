				...
				<table class="table table-xs">
					...
					<tbody>
						<tr class="text-center">
							...
							<td>-</td>
							<td class="py-1">
								<button type="button" class="mx-3"><svg class="w-5 h-5 text-gray-800 dark:text-emerald-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
								...
								<button type=" button" class="mx-3" wire:confirm="Estas seguro?"><svg class="w-5 h-5 text-gray-800 dark:text-red-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
